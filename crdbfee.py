...
class CRDBFeeCalculator:
    ...
    def print_results(self, fees_total: float, vat_total: float):
        ...
        print("├─────────────────────────────────────────────────────────────┤")
        print(f"│  📊  Fees/Charges: {fees_total:>12.2f} {self.currency:<3}              │")
        print(f"│  🏛️   VAT Total:    {vat_total:>12.2f} {self.currency:<3}              │")
        print("├─────────────────────────────────────────────────────────────┤")
        print(f"│  💰  Total Amount:  {total_amount:>12.2f} {self.currency:<3}              │")
        print("└─────────────────────────────────────────────────────────────┘")
